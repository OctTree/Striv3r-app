module AuthorisationResponseConcerns
  def create_access_refresh_token(user)
    ...
    cookies.signed[:wc_token] = {value: token, httponly: true, expires: time}
    cookies.signed[:wc_refresh_token] = {value: refresh_token, httponly: true, expires: refresh_expiry_time}
  ...
  def purge_cookies
    cookies.delete :str_token
    cookies.delete :str_refresh_token
  end
end